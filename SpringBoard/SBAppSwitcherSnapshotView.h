...
@class CAShapeLayer, NSObject, SBAppSwitcherSettings, SBApplication, SBDisplayItem, SBFakeStatusBarView, SBZoomableCrossfadeView, UIView, _SBAppSwitcherSnapshotContext;
