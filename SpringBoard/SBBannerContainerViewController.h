...
#import "NCNotificationActionTextInputDelegate-Protocol.h"
...
@class FBUIApplicationSceneDeactivationAssertion, NCBannerAccessoryHostViewController, NCContentHostViewController, NSObject, NSString, SBBannerButtonViewController, SBBannerContainerView, SBBannerContextView, SBUIBannerContext, UIImage, UIView;
