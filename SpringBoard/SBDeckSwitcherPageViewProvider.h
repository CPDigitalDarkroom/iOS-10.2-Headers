...
#import "SBSwitcherAppViewWrapperPageContentViewDelegate-Protocol.h"

@class NSMutableDictionary, NSString, SBDeckSwitcherPageView;
@protocol OS_dispatch_queue, SBDeckSwitcherPageViewProviderDelegate;
