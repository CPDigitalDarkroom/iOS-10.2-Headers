...
@class NSCountedSet, NSMutableArray, NSMutableSet, NSSet, NSString, SBAppStatusBarSettingsAssertion, SBDisableAppStatusBarAlphaChangesAssertion, SBFLockScreenDateView, SBFakeStatusBarView, SBIrisWallpaperSettings, SBLockOverlayStylePropertiesFactory, SBLockScreenBatteryChargingView, SBLockScreenBounceAnimator, SBLockScreenDeviceInformationTextView, SBLockScreenScrollView, SBLockScreenTimerView, SBLockScreenViewRequesterTracker, SBSlideUpAppGrabberView, SBUIChevronView, SBUIVibrantButton, SBWallpaperEffectView, UIColor, UIGestureRecognizer, UIScrollView, UIView, _UIBackdropView, _UIGlintyStringView, _UILegibilitySettings;
@protocol SBLockScreenViewDelegate, SBPresentingDelegate, SBUILegibility, SBUIPasscodeLockView, _SBFVibrantView;
