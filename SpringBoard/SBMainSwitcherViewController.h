...
@class FBUIApplicationSceneDeactivationAssertion, NSCountedSet, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, SBAppStatusBarSettingsAssertion, SBAppSwitcherRemoteAlertSet, SBAppSwitcherServiceSet, SBAppSwitcherSettings, SBBestAppSuggestion, SBDisplayItem, SBMainDisplayLayoutState, SBSwitcherContainerView, UIViewController, _UILegibilitySettings;
