...
@class NSArray, NSString, SBModeControlManager, SBNCColumnViewController, SBNotificationSeparatorView, UIScrollView, UISwipeGestureRecognizer, UIView;
@protocol SBBulletinActionHandler, SBModeViewControllerContentProviding, SBModeViewControllerDelegate;
