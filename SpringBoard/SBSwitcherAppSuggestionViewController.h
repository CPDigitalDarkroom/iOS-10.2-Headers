...
#import "SBSwitcherAppSuggestionBottomBannerViewDelegate-Protocol.h"

@class NSObject, NSString, SBBestAppSuggestion, SBDeckSwitcherPageView, SBSwitcherAppSuggestionBottomBannerView, UIPanGestureRecognizer, UITapGestureRecognizer;
